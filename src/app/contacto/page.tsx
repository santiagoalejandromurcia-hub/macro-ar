      ...
      <div className="mt-8 p-5 bg-theme-surface border border-theme rounded-xl">
        ...
        <div className="flex gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-theme-card border border-theme text-sm text-theme-secondary hover:text-[var(--fg-0)] hover:border-[var(--celeste)]/30 transition-all"
          >
