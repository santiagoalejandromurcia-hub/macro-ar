...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'CER vs LECAP',
    'BONCER vs LECAP',
    'inflación implícita bonos Argentina',
    'curva CER Argentina',
    'curva LECAP',
    'tasa fija vs CER Argentina',
    'rendimiento bonos CER',
    'TIR LECAP hoy',
    'qué conviene CER o tasa fija',
    'expectativas de inflación Argentina',
    'REM BCRA inflación esperada',
    'bonos CER Argentina 2026',
    'LECER BONCER rendimiento',
    'inflación implícita mercado Argentina',
    'break even inflacion INDEC',
    'conviene invertir en CER 2026',
  ],
  openGraph: {
    type: 'website',
