...
// Las TIRs son APROXIMACIONES del mercado al 10-may-2026.
// Precios de S30S6/S30O6/S30N6/X30S6/X30N6 se refrescaron con
// data912 al 16-sep-2026; el resto de TIRs NO es live (IAMC
// no publica una curva CER gratuita). Bonos ya vencidos se
// sacaron del snapshot.
//
...
export const bonosNominales: Bond[] = [
  { ticker: 'S30S6', tipo: 'lecap',    vencimiento: '2026-09-30', precioArs: 116.63,  tirAnualPct: 20.5, descripcion: 'LECAP vto 30-sep-26' },
  { ticker: 'TO26',  tipo: 'bonte_tf', vencimiento: '2026-10-17', precioArs: 96.99,   tirAnualPct: 20.5, descripcion: 'BONTE 15.5% vto 17-oct-26' },
  { ticker: 'S30O6', tipo: 'lecap',    vencimiento: '2026-10-30', precioArs: 131.89,  tirAnualPct: 20.2, descripcion: 'LECAP vto 30-oct-26' },
  { ticker: 'S30N6', tipo: 'lecap',    vencimiento: '2026-11-30', precioArs: 123.88,  tirAnualPct: 20.0, descripcion: 'LECAP vto 30-nov-26' },
...
export const bonosReales: Bond[] = [
  { ticker: 'X30S6',  tipo: 'lecer',   vencimiento: '2026-09-30', precioArs: 116.64,  tirAnualPct: 5.0, descripcion: 'LECER vto 30-sep-26' },
  ...
  { ticker: 'X30N6',  tipo: 'lecer',   vencimiento: '2026-11-30', precioArs: 125.60,  tirAnualPct: 5.8, descripcion: 'LECER vto 30-nov-26' },
...
// ─── Sendero mensual BEI vs REM (tabla) ──────────────────────
// Actualizado al 21-may-2026 con datos del mercado secundario
export interface SenderoMensual {
  mes: string;
  dias: number;
  bei: number;       // BEI mensual implícita de bonos (%)
  rem: number | null; // Mediana REM BCRA mensual (%)
}

export const senderoMensualBEI: SenderoMensual[] = [
