...
export const SERIES_CATALOG: SeriesCatalogEntry[] = [
  ...
  { id: 'fob-soja', label: 'Soja FOB', aliases: ['soja', 'granos', 'fob', 'commodities'], href: '/?kpi=fob-soja#dashboard', tabs: ['COMMODITIES'], hasCsv: true, sourceHint: 'FOB', icon: '🌾' },
  ...
  { id: 'ypf-super', label: 'Nafta Super', aliases: ['nafta', 'surtidor', 'ypf', 'super', 'combustible'], href: '/?kpi=ypf-super#dashboard', tabs: ['COMMODITIES'], hasCsv: true, sourceHint: 'Surtidores YPF CABA', icon: '⛽' },
  { id: 'ypf-premium', label: 'Nafta Premium', aliases: ['infinia', 'premium'], href: '/?kpi=ypf-premium#dashboard', tabs: ['COMMODITIES'], hasCsv: true, sourceHint: 'Surtidores YPF CABA', icon: '⛽' },
  { id: 'ypf-gasoil', label: 'Gasoil', aliases: ['gasoil', 'diesel'], href: '/?kpi=ypf-gasoil#dashboard', tabs: ['COMMODITIES'], hasCsv: true, sourceHint: 'Surtidores YPF CABA', icon: '⛽' },
  { id: 'ypf-euro', label: 'Diesel Euro', aliases: ['euro', 'diesel premium'], href: '/?kpi=ypf-euro#dashboard', tabs: ['COMMODITIES'], hasCsv: true, sourceHint: 'Surtidores YPF CABA', icon: '⛽' },
