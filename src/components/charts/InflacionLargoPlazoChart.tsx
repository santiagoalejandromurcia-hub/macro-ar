    ...
    >
      <ResponsiveContainer width="100%" height={360}>
        <ComposedChart data={liveData} margin={{ top: 20, right: 10, left: -5, bottom: 5 }}>
          ...
          <ReferenceDot x="Jul-26" y={33.8}  r={6} fill="#22C55E" stroke="#fff" strokeWidth={2} label={{ value: '33,8%', position: 'top', fill: t.textPrimary, fontSize: 10, fontWeight: 600 }} />
        </ComposedChart>
      </ResponsiveContainer>
      ...
      <div className="mt-3 flex flex-wrap gap-x-4 gap-y-1 text-[11px] font-mono text-theme-muted">
        ...
        <span><span className="inline-block w-2 h-2 rounded-full mr-1" style={{ background: '#22C55E' }} />Jul-26: 33,8% (actual)</span>
